    ...
    <div className="bg-surface border border-edge rounded-lg overflow-hidden">
      ...
      <div className="px-4 py-3 border-b border-edge flex items-center gap-3 flex-wrap">
        <input
          ...
          className="px-3 py-1.5 bg-overlay border border-edge rounded-md text-sm text-primary placeholder:text-secondary focus:outline-none focus:border-accent transition-colors w-56"
        />
